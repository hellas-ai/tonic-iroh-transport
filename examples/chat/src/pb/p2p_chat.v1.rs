...
impl ConnectionType {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            ...
            Self::Direct => "CONNECTION_TYPE_DIRECT",
            Self::Relay => "CONNECTION_TYPE_RELAY",
            Self::Unknown => "CONNECTION_TYPE_UNKNOWN",
        }
    }
    ...
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
        match value {
            ...
            "CONNECTION_TYPE_DIRECT" => Some(Self::Direct),
            "CONNECTION_TYPE_RELAY" => Some(Self::Relay),
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        > {
            ...
            let path = http::uri::PathAndQuery::from_static(
                "/p2p_chat.v1.NodeService/GetNodeInfo",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("p2p_chat.v1.NodeService", "GetNodeInfo"));
        ...
        pub async fn ping(
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/p2p_chat.v1.NodeService/Ping",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("p2p_chat.v1.NodeService", "Ping"));
            self.inner.unary(req, path, codec).await
        }
        ...
        > {
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/p2p_chat.v1.NodeService/ListPeers",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("p2p_chat.v1.NodeService", "ListPeers"));
            self.inner.unary(req, path, codec).await
        }
        ...
        > {
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/p2p_chat.v1.NodeService/Shutdown",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("p2p_chat.v1.NodeService", "Shutdown"));
            self.inner.unary(req, path, codec).await
        }
    }
}
...
pub mod node_service_server {
        ...
        B::Error: Into<StdError> + std::marker::Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                ...
                "/p2p_chat.v1.NodeService/Shutdown" => {
                    #[allow(non_camel_case_types)]
                    struct ShutdownSvc<T: NodeService>(pub Arc<T>);
                    impl<
                        T: NodeService,
                    ...
                    for ShutdownSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as NodeService>::shutdown(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
    ...
    pub const SERVICE_NAME: &str = "p2p_chat.v1.NodeService";
...
impl MessageType {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            ...
            Self::Text => "MESSAGE_TYPE_TEXT",
            Self::System => "MESSAGE_TYPE_SYSTEM",
            Self::Heartbeat => "MESSAGE_TYPE_HEARTBEAT",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
pub mod p2p_chat_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        > {
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/p2p_chat.v1.P2PChatService/SendMessage",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("p2p_chat.v1.P2PChatService", "SendMessage"));
            self.inner.unary(req, path, codec).await
        }
        /// Subscribe to incoming messages (server streaming)
        pub async fn subscribe_messages(
            &mut self,
            request: impl tonic::IntoRequest<super::SubscribeMessagesRequest>,
        ) -> std::result::Result<
            tonic::Response<tonic::codec::Streaming<super::SubscribeMessagesResponse>>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/p2p_chat.v1.P2PChatService/SubscribeMessages",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("p2p_chat.v1.P2PChatService", "SubscribeMessages"),
                );
        ...
        > {
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/p2p_chat.v1.P2PChatService/GetHistory",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("p2p_chat.v1.P2PChatService", "GetHistory"));
            self.inner.unary(req, path, codec).await
        }
        /// Bi-directional chat stream
        pub async fn chat_stream(
            &mut self,
            request: impl tonic::IntoStreamingRequest<Message = super::ChatStreamRequest>,
        ) -> std::result::Result<
            tonic::Response<tonic::codec::Streaming<super::ChatStreamResponse>>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/p2p_chat.v1.P2PChatService/ChatStream",
            );
            let mut req = request.into_streaming_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("p2p_chat.v1.P2PChatService", "ChatStream"));
...
pub mod p2p_chat_service_server {
    ...
    pub trait P2pChatService: std::marker::Send + std::marker::Sync + 'static {
        ...
        type SubscribeMessagesStream: tonic::codegen::tokio_stream::Stream<
                Item = std::result::Result<
                    super::SubscribeMessagesResponse,
                    tonic::Status,
                >,
            >
            + std::marker::Send
        ...
        async fn subscribe_messages(
            &self,
            request: tonic::Request<super::SubscribeMessagesRequest>,
        ) -> std::result::Result<
        ...
        type ChatStreamStream: tonic::codegen::tokio_stream::Stream<
                Item = std::result::Result<super::ChatStreamResponse, tonic::Status>,
            >
            + std::marker::Send
            + 'static;
        /// Bi-directional chat stream
        async fn chat_stream(
            &self,
            request: tonic::Request<tonic::Streaming<super::ChatStreamRequest>>,
            ...
            match req.uri().path() {
                ...
                "/p2p_chat.v1.P2PChatService/SubscribeMessages" => {
                    ...
                    > tonic::server::ServerStreamingService<
                        super::SubscribeMessagesRequest,
                    > for SubscribeMessagesSvc<T> {
                        type Response = super::SubscribeMessagesResponse;
                ...
                "/p2p_chat.v1.P2PChatService/ChatStream" => {
                    ...
                    impl<
                        T: P2pChatService,
                    > tonic::server::StreamingService<super::ChatStreamRequest>
                    for ChatStreamSvc<T> {
                        type Response = super::ChatStreamResponse;
                        ...
                        fn call(
                            ...
                            request: tonic::Request<
                                tonic::Streaming<super::ChatStreamRequest>,
                            >,
                        ) -> Self::Future {
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
    ...
    /// Generated gRPC service name
    pub const SERVICE_NAME: &str = "p2p_chat.v1.P2PChatService";
